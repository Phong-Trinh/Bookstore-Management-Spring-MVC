			...
			<div
				...
				<div
					...
					<div class="col-md-8 col-lg-7 col-xl-6">
						<img
							src='<c:url value="resources/images/unnamed.jpg"></c:url>'"			
							class="img-fluid" alt="Phone image">
					</div>
					<div class="col-md-7 col-xl-5">
						<h1 style="color: #560bad" class="font-weight-medium">Đăng
							nhập</h1>
						<p style="font-style: italic">Trang web hỗ trợ các chức năng
							buôn bán văn phòng phẩm dành cho quản lí và nhân viên tại cửa
							hàng</p>

						<!-- /login?error=true -->
						<%-- 						<c:if test="${haveError != null}">
						...
						<form name='f'
							...
							<div class="form-outline mb-2">
								<input type="text" id="form1Example13"
									placeholder="Nhập tên đăng nhập" name="username" value="${username}"
							...
							<div class="form-outline mb-2">
								...
								<label
									class="form-label" for="form1Example23"
							...
							<div
								...
								<a class="forget-link" href="forget-password.htm" style="font-size: 18px">Quên mật khẩu ?</a>
							</div>
