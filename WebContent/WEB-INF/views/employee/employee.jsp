							...
							<div class="card-body">
								<div class="row">
									...
									<form:form modelAttribute="nhanVien"
										...
										<h4 class="mb-4 text-dark font-weight-medium">Thông tin
											nhân viên</h4>
										<div class="mt-4">
											<div class="row">
												<div class="col-3">
													...
													<form:input class="form-control only-number" path="cmnd"
												...
												<div class="col-3">
													...
													<form:input class="form-control valid-char" path="Ho"
												...
												<div class="col-3">
													...
													<form:input class="form-control valid-char" path="Ten"
											...
											<div class="row mt-3">
												<div class="col-3">
													...
													<h6 class="text-danger font-weight-medium">
														<form:errors path="email" class="error-message date-err" />
													</h6>
											...
											<div class="row mt-3 justify-content-center">
												<div class="col-3">
													...
													<form:input class="form-control valid-char ${disableInput}" path="chucVu"
												...
												<div class="col-3">
													...
													<form:input class="form-control only-number ${disableInput}" path="luong"
												...
												<div class="col-3 d-none">
													...
													<div class="form-check form-check-inline">
														...
														<label class="form-check-label" for="inlineRadio">Đã giao dịch</label>
													</div>
												</div>
											</div>
									...
									<div class="table-responsive">
										...
										<div class="d-flex justify-content-between">
											...
											<div class="d-flex">
												...
												<span class="ml-2 mr-"> Xóa: <i class="fas fa-trash"
													style="color: #ff4f70"></i>
												</span>
												<span class="ml-2 mr-"> QL tài khoản: 
													<i class="fas fa-user-circle" style="color: #5f76e8"></i>
												</span>
											</div>
										</div>
												...
												<c:forEach items="${pagedListHolder.pageList}"
													...
													<tr>
														...
														<td class="text-center align-middle">
															...
															<a
																href="employee/account/${employee.getID_NV()}.htm"
																class="edit-product ml-2"> <i class="fas fa-user-circle" style="color: #5f76e8"></i>
															</a> 
															<c:if test="${!employee.getDaGiaoDich()}">
