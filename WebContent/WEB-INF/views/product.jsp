											...
											<div class="row mt-4">
												...
												<div class="col">
													<h6
														class="text-danger position-absolute font-weight-medium"
														style="top: -12px;">
														<form:errors path="giaNhap" class="error-message" />
													</h6>
													<label for="gianhap">Giá nhập</label>
													<form:input class="form-control only-number" path="giaNhap"
														...
														<c:choose>
															<c:when
																...
																<button name="${btnStatus}"
																	class="btn ${btnStatus} waves-effect ${daThem} waves-light btn-success">${btnContent}</button>
															</c:when>
															<c:otherwise>
																<button name="${btnStatus}"
																	class="btn ${btnStatus} waves-effect ${daThem} waves-light btn-success"
