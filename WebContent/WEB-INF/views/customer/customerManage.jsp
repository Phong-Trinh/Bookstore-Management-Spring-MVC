			...
			<div class="container-fluid">
				<div class="row">
										...
										<div class="mt-4">
											<div class="row">
												...
												<div class="col">									
													...
													<h6 class="text-danger font-weight-medium">
														<form:errors path="ngaySinh" class="error-message date-err" />
													</h6>
								...
								<div class="row">
									<div class="table-responsive">
										...
										<form action="customer/index.htm" class="mb-3">
											...
											<div class="row w-100">
												<div class="col-1">
													<input type="text" class="form-control only-number" name="idCustomerSearch"
														placeholder="ID">
												</div>
												<div class="col-3">
													<input type="text" class="form-control"
														name="inforCustomerSearch" placeholder="Nhập họ, tên, sdt,..">
												</div>
												<div class="col-3">
														...
														<td class="text-center align-middle"><a
															...
															class="edit-product"> <i class="fas fa-pencil-alt"
																...
																<a class="edit-product ml-3" style="cursor: pointer"
																	onclick="showWarningModal('customer/delete/${customer.getId()}.htm', '${customer.getTen()}')"> <i
					...
					<footer class="footer text-center text-muted w-100">
						All Rights Reserved by Group 23 D19CQCN01-N
						<span style="display: none" class="xacdinh-sidebar">${activeMapping}</span>
