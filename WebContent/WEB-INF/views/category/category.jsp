					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-12">
										<h3 class="mb-2 mt-2 text-dark font-weight-medium">Tạo
											phiếu nhập</h3>
								...
								<div class="row">
									...
									<div class="d-flex justify-content-between w-100">
										...
										<div>
											...
											</span> <span> Xóa: <i class="fas fa-trash"
									...
									<div
										style="max-height: 500px; overflow: auto; width: 100% ">
