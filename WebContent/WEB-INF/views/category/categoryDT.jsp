						...
						<div class="card">
							<div class="card-body">
								<div class="row flex-column">
									<!--Search form-->
									<form action="category/actions.htm" class="mb-3">
												...
												<c:forEach items="${products}" var="product">
													<tr data-set="${product.getID_VPP()}" class="table-item">
														...
														<td class="text-center align-middle product-price"><fmt:formatNumber
																value="${product.getGiaNhap()}" type="currency"
													...
													<c:forEach items="${cacCTPN}" var="ctpn">
														<tr class="table-choosen">
															...
															<td class="text-center align-middle calculated-price">
																<fmt:formatNumber value="${ctpn.getDonGiaNhap()}"
